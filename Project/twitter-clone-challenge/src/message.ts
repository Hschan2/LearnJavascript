export const messages = {
  ...
  serviceError: {
    ...
    failedFollow: "팔로우 실패: {errorMessage}",
    failedUnfollow: "언팔로우 실패: {errorMessage}",
    failedFetchFollowingStatus: "팔로잉 여부 확인 실패: {errorMessage}",
    failedFetchFollowingCount: "팔로잉 목록 가져오기 실패: {errorMessage}",
    failedFetchFollowerCount: "팔로워 목록 가져오기 실패: {errorMessage}",
    failedFetchUserData: "유저 데이터 가져오기 실패: {errorMessage}",
    failedUpdateTweet: "트윗 업데이트 실패: {errorMessage}",
    failedAddComment: "댓글 작성 실패: {errorMessage}",
    failedUpdateComment: "댓글 수정 실패: {errorMessage}",
    failedDeleteComment: "댓글 삭제 실패: {errorMessage}",
    failedToggleCommentLike: "댓글 좋아요 실패: {errorMessage}",
    failedAddReply: "답변 추가 실패: {errorMessage}",
    failedUpdateReply: "답변 수정 실패: {errorMessage}",
    failedUpdateReplyCount: "답변 개수 업데이트 실패: {errorMessage}",
    failedDeleteReply: "답변 삭제 실패: {errorMessage}",
    failedToggleReplyLike: "답변 좋아요 처리 실패: {errorMessage}",
    failedPostTweet: "트윗 포스팅 실패: {errorMessage}",
    tweetNotFound: "Tweet을 찾을 수 없습니다.",
    failedUpdateTweetFetch: "Tweet 수정 실패: {errorMessage}",
    failedDeleteTweetOperation: "삭제 중 오류 발생: {errorMessage}",
    failedLogoutOperation: "로그아웃 실패: {errorMessage}",
    failedDeleteUserData: "회원 데이터 삭제 실패: {errorMessage}",
    failedDeleteAccount: "계정 삭제 실패: {errorMessage}",
  ...
  serviceMessage: {
    ...
    checkDeleteReply: "정말로 이 답변을 삭제하시겠습니까?",
